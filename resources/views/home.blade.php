                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">My Video</h6>
                        </div>
                        <div class="card-body">
                            @if(session('session'))
                                            ...
                                            <td>
                                                <div class="row ">
                                                    <a href="{{route('show.video', ['id'=>$row->id])}}">
                                                        ...
                                                        <div class=" col-6">
                                                            <div class=" mt-0">
                                                                <h6 class="post-title p mb-2">{{$row["title"]}}</h6>
                                                                <p class="mb-2 p text-body" style="font-size: 12px;">{{$row->summary}}</p>
                                                            </div>
